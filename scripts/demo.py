...
async def run_demo(backend_url: str):
    ...
    console.print(Panel.fit("[bold blue]🛡️  AgentOps Security Mesh Demo[/bold blue]", border_style="blue"))
    ...
    summary = Text()
    summary.append("\n🎉 Demo Complete! 🎉\n", style="bold green")
    summary.append("Despite 3 targeted attacks, the LangGraph swarm completed the task securely without human intervention.\n")
